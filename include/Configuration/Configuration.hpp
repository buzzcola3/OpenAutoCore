...
public:
    ...
    std::string getBluetoothWifiInterface() const override;
    void setBluetoothWifiInterface(const std::string& value) override;
...
private:
    ...
    std::string bluetoothWifiInterface_;
    ...
    static const std::string cBluetoothWifiInterfaceKey;
