...
namespace aasdk {
  namespace messenger {
    ...
    FrameHeader::FrameHeader(ChannelId channelId, FrameType frameType, EncryptionType encryptionType,
    ...
    common::Data FrameHeader::getData() const {
      ...
      data.push_back(static_cast<uint8_t>(encryptionType_) | static_cast<uint8_t>(messageType_) |
                     static_cast<uint8_t>(frameType_));
